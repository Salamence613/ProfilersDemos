...
class Graph:
    ...
    def pushB(self, stack, node):
        stack.append(node)

    def DFS_B(self, s):  # prints all vertices in DFS manner from a given source.
...
cProfile.run("main()", filename="dfsB.prof")
